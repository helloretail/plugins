...
| Where a Search design (Liquid/CSS/JS) comes from — Hello Retail's system supplies it when a new search is created; the wiki keeps no copy | `base-templates/search/README.md` |
